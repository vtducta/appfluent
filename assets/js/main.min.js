...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    side_bar.metisMenu(), setup_menu.metisMenu(), $(".hide-menu").click(function(e) {
        e.preventDefault(), $("body").hasClass("hide-sidebar") ? $("body").removeClass("hide-sidebar").addClass("show-sidebar") : $("body").removeClass("show-sidebar").addClass("hide-sidebar")//,
    ...
    $.each($('._filter_special input'),function(){
        d[$(this).attr('name')] = '[name="'+$(this).attr('name')+'"]';
    });
    ...
    $('._select_filter_lead').on('change',function(){
        _table_api.ajax.reload();
    })

    $('._input_filter_lead').on('keyup',function(){
        _table_api.ajax.reload();
    });
    $('._input_filter_lead').on('blur',function(){
        _table_api.ajax.reload();
    });
    $('._dt_filter_lead').on('blur',function(){
        _table_api.ajax.reload();
    });
...
$(function() {
    ...
    // $('#menu').hover(function() {
    //     $( "#menu_button" ).css('width','200px');
    // });
    $('#menu').mouseover(function() {
        $( "#menu_button" ).css('width','200px');
        $('._display_delay').addClass('show_span_menu');
    });
    $('#menu').mouseleave(function() {
        $( "#menu_button" ).css('width','');
        $('._display_delay').removeClass('show_span_menu');
    });
});
