...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    side_bar.metisMenu(), setup_menu.metisMenu(), $(".hide-menu").click(function(e) {
        e.preventDefault(), $("body").hasClass("hide-sidebar") ? $("body").removeClass("hide-sidebar").addClass("show-sidebar") : $("body").removeClass("show-sidebar").addClass("hide-sidebar"), setup_menu.hasClass("display-block") && setup_menu.addClass(isRTL == 'true' ? "fadeOutRight" : "fadeOutLeft"),
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function() {
        ...
        e.preventDefault(),$("#menu").show(),$('body').removeClass('show-sidebar').addClass('hide-sidebar'), setup_menu.addClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft"), requestGet("misc/set_setup_menu_closed")
    }), $(".open-customizer").on("click", function(e) {
        e.preventDefault(),  $("#menu").hide(),$('body').removeClass('hide-sidebar').addClass('show-sidebar'), setup_menu.hasClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft") && setup_menu.removeClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft"), setup_menu.addClass("display-block " + ("true" == isRTL ? "fadeInRight" : "fadeInLeft")), is_mobile() || requestGet("misc/set_setup_menu_open"), mainWrapperHeightFix()
...
function add_event_search_custom_field(){
    // Top search input fetch results
    $('.search_related_to_contact').on('keyup paste', function() {
        console.log('typing search contacts');
        var q = $(this).val().trim();
        var tag_id= $(this).attr('id');
        var fillto = $(this).attr("name").replace("related_to_contact_","contact_related_to_search_results_");
        var search_results = $('div[name="'+fillto+'"]');
        if (q === '') {
        ...
        delay(function() {
            ...
            $.post(admin_url + 'misc/search_contact_related_to', { q: q,tag: tag_id }).done(function(results) {
                content_wrapper.unhighlight();
    ...
    $('.search_related_to_company').on('keyup paste', function() {
        var q = $(this).val().trim();
        var tag_id= $(this).attr('id');
        var fillto = $(this).attr("name").replace("related_to_company_","company_related_to_search_results_");
        var search_results = $('div[name="'+fillto+'"]');
        if (q === '') {
            content_wrapper.unhighlight();
            search_results.html('');
        ...
        delay(function() {
            if (q == original_top_search_val) { return; }
            $.post(admin_url + 'misc/search_company_related_to', { q: q,tag: tag_id }).done(function(results) {
                content_wrapper.unhighlight();
                search_results.html(results);
                content_wrapper.highlight(q);
                original_top_search_val = q;
...
function set_contact_related_to_tag(tag_id,id,value) {
    var hide_tag_id = tag_id.replace("related_to_contact_","");
    $('input[id="'+tag_id+'"]').val(value);
    $('input[id="'+hide_tag_id+'"]').val(id);
};

function set_company_related_to_tag(tag_id,id,value) {
    var hide_tag_id = tag_id.replace("related_to_company_","");
    $('input[id="'+tag_id+'"]').val(value);
    $('input[id="'+hide_tag_id+'"]').val(id);
};