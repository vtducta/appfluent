...
(function(a) {
    ...
    a.fn.iconpicker = function(b) {
     ...
     c.defaultOptions.icons = ["mdi-home","mdi-account-multiple","mdi-file","mdi-inbox","mdi-calendar-range","mdi-timer-sand-full","mdi-chart-pie","mdi-cogs","mdi-trash-can","mdi-account","mdi-marker-check","mdi-youtube-tv","mdi-camera-account","mdi-contacts","mdi-currency-usd","mdi-briefcase-check","mdi-format-list-checks","mdi-notebook"];
});