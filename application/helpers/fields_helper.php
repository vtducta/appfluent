...
function render_related_to_contact($name, $label = '', $value = '',$valueName='', $type = 'text', $input_attrs = array(), $form_group_attr = array(), $form_group_class = '', $input_class = '')
{
    $input            = '';
    $_form_group_attr = '';
    $_input_attrs     = '';
    ...
    $input .= '<div  app-field-wrapper="related_to_contact_'.$name.'" class="dropdown form-group' . $form_group_class . '" ' . $_form_group_attr . '>';
    if ($label != '') {
        $input .= '<label for="' . $name . '" class="control-label">' . _l($label,'',false) . '</label>';
    }
    $input .= '<input type="' . $type . '" id="' . $name . '" name="' . $name . '" class="hide form-control' . $input_class . '" ' . $_input_attrs . ' value="' . set_value($name, $value) . '">';

    $input .= '<input placeholder="Type to seach contact" data-toggle="dropdown" type="text" id="related_to_contact_'.$name.'" name="related_to_contact_'.$name.'" class="form-control search_related_to_contact"  value="'.$valueName.'" aria-invalid="false">';
    $input .= '<div name="contact_related_to_search_results_'.$name.'" class="dropdown-menu"  style="position: relative"></div>';
    $input .= '</div>';
    return $input;
}

function render_related_to_company($name, $label = '', $value = '',$valueName='', $type = 'text', $input_attrs = array(), $form_group_attr = array(), $form_group_class = '', $input_class = '')
{
    $input            = '';
    $_form_group_attr = '';
    $_input_attrs     = '';
    ...
    $input .= '<div  app-field-wrapper="related_to_company_'.$name.'" class="dropdown form-group' . $form_group_class . '" ' . $_form_group_attr . '>';
    if ($label != '') {
        $input .= '<label for="' . $name . '" class="control-label">' . _l($label,'',false) . '</label>';
    }
    $input .= '<input type="' . $type . '" id="' . $name . '" name="' . $name . '" class="hide form-control' . $input_class . '" ' . $_input_attrs . ' value="' . set_value($name, $value) . '">';

    $input .= '<input placeholder="Type to seach company" data-toggle="dropdown" type="text" id="related_to_company_'.$name.'" name="related_to_company_'.$name.'" class="form-control search_related_to_company"  value="'.$valueName.'" aria-invalid="false">';
    $input .= '<div name="company_related_to_search_results_'.$name.'" class="dropdown-menu"  style="position: relative"></div>';
    $input .= '</div>';
    return $input;
}

function render_option($option_value, $label, $tooltip = '', $replace_yes_text = '', $replace_no_text = '', $replace_1 = '',$replace_0 = '')
{
    ob_start(); ?>
    <div class="form-group">
        <label for="<?php echo $option_value; ?>" class="control-label clearfix">
        ...
        <div class="radio radio-primary radio-inline">
            <input type="radio" id="y_opt_1_<?php echo $label;?>" name="settings[<?php echo $option_value;?>]" value="<?php echo $replace_1 == '' ? 1 : $replace_1; ?>"
                <?php  if ($option_value == ($replace_1 == '' ? '1' : $replace_1)) { echo 'checked'; } ?> >
            <label for="y_opt_1_<?php echo $label; ?>">
                <?php echo $replace_yes_text == '' ? _l('settings_yes') : $replace_yes_text;?>
            </label>
        </div>
        <div class="radio radio-primary radio-inline">
            <input type="radio" id="y_opt_2_<?php echo $label;?>" name="settings[<?php echo $option_value;?>]" value="<?php echo $replace_0 == '' ? 0 : $replace_0; ?>" <?php if ($option_value == ($replace_0 == '' ? '0' : $replace_0)) { echo 'checked'; } ?>>
            <label for="y_opt_2_<?php echo $label;?>">
                <?php echo $replace_no_text == '' ? _l('settings_no') : $replace_no_text;?>
            </label>
        </div>
