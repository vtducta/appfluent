                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="customers_field_info mbot25 alert alert-info<?php if(isset($custom_field) && $custom_field->fieldto != 'customers' || !isset($custom_field)){echo ' hide';} ?>">
                            ...
                            ?>
                        <label for="custom_tab"><?php echo _l('custom_field_add_edit_custom_tab'); ?></label>
                        <select name="custom_tab_id" id="custom_tab_id" class="selectpicker" data-width="100%"  data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <option value=""></option>
                            <?php

                            foreach ($list_custom_tab as $custom_tab) {
                                ?>
                                <option value="<?= $custom_tab['id']?>" <?php if(isset($custom_field) && $custom_field->custom_tab_id == $custom_tab['id']){echo 'selected';} ?>><?php echo ($custom_tab['name']); ?></option>
                        ...
                        <div class="clearfix mbot15"></div>
                            ...
                            <select name="fieldto" id="fieldto" class="selectpicker" data-width="100%" <?php echo $disable; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                ...
                                <option value="policies" <?php if(isset($custom_field) && $custom_field->fieldto == 'policies'){echo 'selected';} ?>><?php echo _l('custom_field_policies'); ?></option>
                                ...
                                <option value="call_logs" <?php if(isset($custom_field) && $custom_field->fieldto == 'call_logs'){echo 'selected';} ?>><?php echo _l('call_logs'); ?></option>
                            </select>
                            <div class="clearfix mbot15"></div>
                            ...
                            <select name="type" id="type" class="selectpicker"<?php if(isset($custom_field) && total_rows('tblcustomfieldsvalues',array('fieldid'=>$custom_field->id,'fieldto'=>$custom_field->fieldto)) > 0 && ($custom_field->type == 'checkbox' || $custom_field->type == 'select' || $custom_field->type == 'multiselect')){echo ' disabled';} ?> data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                ...
                                <option value="contact" <?php if(isset($custom_field) && $custom_field->type == 'contact'){echo 'selected';} ?>>Related to contact</option>
                                <option value="company" <?php if(isset($custom_field) && $custom_field->type == 'company'){echo 'selected';} ?>>Related to company</option>
                            </select>
                            <div class="clearfix mbot15"></div>
