...
$customer_tabs = array(
  array(
    'name'=>'profile',
    'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=profile_families'),
  ...
  array(
        'name'=>'timeline',
        'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=timeline'),
  ...
  array(
    'name'=>'notes',
    'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=notes_families'),
...
//    ),
    array(
    'name'=>'tasks',
    'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=tasks_families'),
    'icon'=>'fa fa-tasks',
    'lang'=>_l('tasks'),
    'visible'=>true,
    'order'=>5
  ...
  array(
    'name'=>'tickets',
    'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=tickets_families'),
    'icon'=>'fa fa-ticket',
    'lang'=>_l('tickets'),
  ...
  array(
    'name'=>'attachments',
    'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=attachments_families'),
    ...
    array(
        'name'=>'campaign',
        'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=campaign'),
        'icon'=>'fa fa-hourglass-o',
        'lang'=>_l('Campaign'),
        'visible'=>true,
        'order'=>9
    ...
    array(
        'name'=>'events',
        'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=events'),
        'icon'=>'fa fa-calendar',
        'lang'=>_l('Events'),
        'visible'=>true,
        'order'=>6
    ...
    array(
        'name'=>'emails',
        'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=emails'),
        'icon'=>'fa fa-send-o',
        'lang'=>_l('Emails'),
        'visible'=>true,
        'order'=>3
    ...
    array(
        'name'=>'policies',
        'url'=>admin_url('client_families/client/'.$client->userid.'/'.$contact->id.'?group=policies'),
