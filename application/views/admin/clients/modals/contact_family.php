...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/client_families/contact/'.$customer_id.'/'.$contactid,array('id'=>'contact-form','autocomplete'=>'off')); ?>
            ...
            <div class="modal-body">
                ...
                <?php } ?>
                <hr class="hide" />
                <p class="bold hide"><?php echo _l('customer_permissions'); ?></p>
                <p class="text-danger hide"><?php echo _l('contact_permissions_info'); ?></p>
                <?php
                ...
                <?php } ?>
                 <hr class="hide" />
                <p class="bold hide"><?php echo _l('email_notifications'); ?></p>
                <div id="contact_email_notifications" class="hide">
