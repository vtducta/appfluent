                    ...
                    <div class="col-md-12">
                        <div class="horizontal-scrollable-tabs">
                            ...
                            <div class="horizontal-tabs">
                                <ul class="nav nav-tabs profile-tabs row customer-profile-tabs nav-tabs-horizontal" style="margin-left: -15px; margin-right: -15px" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="#contact_basic_info" aria-controls="contact_basic_info" role="tab" data-toggle="tab">
                                            <?php echo _l( 'contact_basic_info'); ?>
                                        </a>
                                    </li>
                                    <?php do_action('after_contact_basic_info_tab',false); ?>
                                    <li role="presentation" >
                                        <a href="#contact_other_info" aria-controls="contact_other_info" role="tab" data-toggle="tab">
